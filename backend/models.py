...
class User(db.Model):
    ...
    bookings = db.relationship("Booking", backref="creator", foreign_keys="Booking.created_by")
...
class Company(db.Model):
    ...
    bookings = db.relationship("Booking", backref="company")
...
class Booking(db.Model):
    ...
    status = db.Column(db.String(20), nullable=False, default="PENDING")  # PENDING, APPROVED, REJECTED, DONE
